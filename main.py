...
async def ask_ai(req: ChatPayload):
    ...
    for k in GEMINI_KEYS:
        try:
            ...
            resp = cl.models.generate_content(model='gemini-2.5-flash-lite', contents=ctx, config=types.GenerateContentConfig(system_instruction=system_instr, temperature=0.2))
            ans = resp.text
